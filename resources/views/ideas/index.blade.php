    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                {{--for para mostrar las ideas--}}       
              @forelse($ideas as $idea)
                
          
                <div class="p-6 flex space-x-2">

                     {{--podemos meter en un componente un svg de una bombilla, para no tener mucho codigo aqui. y lo mandamos llamar--}} 
                    ...
                    <div class="flex-1 pl-3">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                {{--a menos que la siguiente directiva se cumpla. has lo de abajo. si se ha editado la nota,mostrar lo de abajo.--}}
              ...
              @empty
                <h2 class="text-xl text-white p-4">No existen ideas aún.</h2>
              @endforelse  
                {{--endfor--}}
            </div>
        </div>
